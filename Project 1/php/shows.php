...
<?php 
	...
	//$ticketmasterLink = get_field("ticketmaster_link", $showID);
	...
	// Social Media
	$websiteURL = get_field("website_url", $showID);
	$facebookURL = get_field("facebook_url", $showID);
	$twitterURL = get_field("twitter_url", $showID);
	$soundcloudURL = get_field("soundcloud_url", $showID);
	$youtubeChannel = get_field("youtube_channel", $showID);
?>
<!-- show-card-container -->
	<div class="show-card-container hide-show <?php echo $showMonthClass . " " . $showType; ?>" data-month="<?php echo $showMonth; ?>" >
		<div id="show<?php the_id(); ?>" class="show-date">
			<?php echo "<span class='date'>" . $dayOfWeek . ' ' . $showMonth. '. ' . $dayNumber . ' ' . $y . "</span>"; ?><span class="show-time"><?php echo $showTime; ?></span>
			...
			<span class="ticketmaster-link"></span>
		...
		<div class="show-info">
			...
			<div id="show<?php the_id(); ?>" class="show-title">
				...
				<div class="show-button-container">
					<a href="#" class="btn btn-lg purchase"><?php echo $ticketsText; ?></a>
...
// Get 8 most recent published shows for Just Announced filter
...
//Define the Just Announced loop based on arguments
...
?>
<!-- show-card-container -->
	<div class="show-card-container just-announced hide-show" >
...
<?php endwhile; ?>
<!-- END: JUST ANNOUNCED SHOWS -->

</div>
<div class="clearfix"></div>
<div id="load-more-shows">
	<button class="btn btn-lg load-more">VIEW MORE SHOWS</button>
